...
2. How many earthquakes of magnitude greater than 2.5 are there in ````quakes.json````?

3. What's the magnitude of the biggest earthquake in ````quakes.json````?

4. What's the magnitude of the oldest earthquake in ````quakes.json````?

5. When did the oldest earthquake in ````quakes.json```` occur?
